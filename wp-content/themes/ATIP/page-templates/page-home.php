								...
								<div class="w-100 p-5" style="padding-top: 5rem !important;">
									<div class="container">
										<div class="row">
											...
											<div class="col-6">
												<a href="<?php echo $featured_link; ?>" class="d-flex"><i class="far fa-2x fa-arrow-alt-circle-right text-lightgreen w-25"></i><span
															class="text-light text-sm w-75 ps-4"><?php echo $featured_link_text; ?></span></a>
											</div>
										</div>
									</div>
								</div>
