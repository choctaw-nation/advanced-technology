...
function bootscore_scripts()
{
    ...
    // Fontawesome
    wp_enqueue_style('animate-on-scroll', get_template_directory_uri() . '/css/lib/aos.css');

    // Style CSS
    wp_enqueue_style('bootscore-style', get_stylesheet_uri(), array(), '1.0.0',);
    ...
    if ( is_front_page() ) {
        ...
        // Particles JS
        wp_enqueue_script('particles', get_template_directory_uri() . '/js/lib/particles.js', array(), '20151215', true);

        wp_enqueue_script('home-script', get_template_directory_uri() . '/js/page-home.js', array(), '20221115', true);
    }

    // News Single CSS
    if ( is_singular( 'news' ) ) {
        wp_enqueue_style( 'news-single-style', get_template_directory_uri() . '/css/single-news.css');
    }
    
    // Staff Single CSS
    if ( is_singular( 'staff' ) ) {
        wp_enqueue_style( 'staff-single-style', get_template_directory_uri() . '/css/single-staff.css');
    }

    // Staff Archive CSS
    if ( is_archive( 'staff' ) ) {
        wp_enqueue_style( 'staff-archive-style', get_template_directory_uri() . '/css/archive-staff.css');
    }
    ...
    // Bootstrap JS
    wp_enqueue_script('animate-on-scroll', get_template_directory_uri() . '/js/lib/aos.js', array(), '20151215', true);
...
$roots_includes = array(
	...
	'/functions/yoast.php',
	'/functions/preload-fix.php',
	'/functions/remove-gutenberg.php',
	'/functions/remove-editor.php',
);
